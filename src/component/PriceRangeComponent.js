...
//       console.log("newValuekkkjh000---->", newValue);

//       setSliderValue(newValue); // Update the state with the new value
//       auth?.setProjectTypeId(newValue);
...
//   ];
//   useEffect(() => {
//     console.log("hjdshjd000----->", sliderValue);
//     auth?.setPriceRangeState(sliderValue[0]);
//     // log
//   }, [sliderValue]); // Empty dependency array to run the effect only once
